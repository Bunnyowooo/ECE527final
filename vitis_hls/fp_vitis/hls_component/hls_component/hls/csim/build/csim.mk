...
HLS_SOURCES = ../../../../testbench.cpp ../../../../autoencoder.cpp
...
$(ObjDir)/autoencoder.o: ../../../../autoencoder.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../autoencoder.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/autoencoder.d
