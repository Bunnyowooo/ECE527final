...
entity myproject_lshr_1024ns_10ns_1024_6_1 is
    generic (
      ID : INTEGER := 1;            --core ID, unused in RTL
      din0_WIDTH : INTEGER := 1024;  --data bitwidth
      din1_WIDTH : INTEGER := 1024;    --shift control bitwidth
      dout_WIDTH : INTEGER := 1024;  --output bitwidth
...
end entity myproject_lshr_1024ns_10ns_1024_6_1;
architecture rtl of myproject_lshr_1024ns_10ns_1024_6_1 is
