; ModuleID = '/home/ubuntu2004/527_final/mini_ae_latency_cli/myproject_prj/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @"arraycpy_hls.p0a64struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"([64 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %dst, [64 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* readonly %src, i64 %num) local_unnamed_addr #1 {
entry:
  %0 = icmp eq [64 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %src, null
  %1 = icmp eq [64 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %dst, null
  %2 = or i1 %1, %0
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  %src.addr.0.0.05 = getelementptr [64 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"], [64 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %src, i64 0, i64 %for.loop.idx8, i32 0, i32 0, i32 0
  %dst.addr.0.0.06 = getelementptr [64 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"], [64 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %dst, i64 0, i64 %for.loop.idx8, i32 0, i32 0, i32 0
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a64struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.35"(i1024* nocapture "orig.arg.no"="0" "unpacked"="0.0" %dst, i64 %dst_shift, [64 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* readonly "orig.arg.no"="1" "unpacked"="1" %src, i64 "orig.arg.no"="2" "unpacked"="2" %num) #1 {
entry:
  %0 = icmp eq [64 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %src, null
  br i1 %0, label %ret, label %copy
...
; Function Attrs: argmemonly noinline norecurse
define internal void @"onebyonecpy_hls.p0a64struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.32"(i1024* noalias nocapture align 512 "orig.arg.no"="0" "unpacked"="0.0" %dst, [64 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* noalias readonly "orig.arg.no"="1" "unpacked"="1" %src) #2 {
entry:
  %0 = icmp eq [64 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a64struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.35"(i1024* %dst, i64 0, [64 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %src, i64 64)
  br label %ret
...
copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a64struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.28"([64 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %dst, i1024* %src, i64 0, i64 64)
  br label %ret
...
entry:
  ...
  call void @"onebyonecpy_hls.p0a64struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.65.68"([64 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %2, i16* align 512 %_0, i16* align 512 %_1, i16* align 512 %_2, i16* align 512 %_3, i16* align 512 %_4, i16* align 512 %_5, i16* align 512 %_6, i16* align 512 %_7, i16* align 512 %_8, i16* align 512 %_9, i16* align 512 %_10, i16* align 512 %_11, i16* align 512 %_12, i16* align 512 %_13, i16* align 512 %_14, i16* align 512 %_15, i16* align 512 %_16, i16* align 512 %_17, i16* align 512 %_18, i16* align 512 %_19, i16* align 512 %_20, i16* align 512 %_21, i16* align 512 %_22, i16* align 512 %_23, i16* align 512 %_24, i16* align 512 %_25, i16* align 512 %_26, i16* align 512 %_27, i16* align 512 %_28, i16* align 512 %_29, i16* align 512 %_30, i16* align 512 %_31, i16* align 512 %_32, i16* align 512 %_33, i16* align 512 %_34, i16* align 512 %_35, i16* align 512 %_36, i16* align 512 %_37, i16* align 512 %_38, i16* align 512 %_39, i16* align 512 %_40, i16* align 512 %_41, i16* align 512 %_42, i16* align 512 %_43, i16* align 512 %_44, i16* align 512 %_45, i16* align 512 %_46, i16* align 512 %_47, i16* align 512 %_48, i16* align 512 %_49, i16* align 512 %_50, i16* align 512 %_51, i16* align 512 %_52, i16* align 512 %_53, i16* align 512 %_54, i16* align 512 %_55, i16* align 512 %_56, i16* align 512 %_57, i16* align 512 %_58, i16* align 512 %_59, i16* align 512 %_60, i16* align 512 %_61, i16* align 512 %_62, i16* align 512 %_63)
  ret void
}
