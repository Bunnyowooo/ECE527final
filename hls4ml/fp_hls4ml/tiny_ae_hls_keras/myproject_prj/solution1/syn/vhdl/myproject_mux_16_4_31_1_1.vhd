...
entity myproject_mux_16_4_31_1_1 is
generic (
    ID            :integer := 0;
    NUM_STAGE     :integer := 1;
...
architecture rtl of myproject_mux_16_4_31_1_1 is
    ...
    signal mux_1_5    : std_logic_vector(30 downto 0);
    signal mux_1_6    : std_logic_vector(30 downto 0);
    signal mux_1_7    : std_logic_vector(30 downto 0);
    -- level 2 signals
    ...
    signal mux_2_3    : std_logic_vector(30 downto 0);
    -- level 3 signals
